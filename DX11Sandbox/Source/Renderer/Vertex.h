...
struct VertexPosUVNormals
{
    ...
    {
        { "POSITION", 0, DXGI_FORMAT::DXGI_FORMAT_R32G32B32_FLOAT, 0 /*input slot*/, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
        { "NORMAL", 0, DXGI_FORMAT::DXGI_FORMAT_R32G32B32_FLOAT, 1 /*input slot*/, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
        { "UV", 0, DXGI_FORMAT::DXGI_FORMAT_R32G32_FLOAT, 2 /*input slot*/, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
    };
