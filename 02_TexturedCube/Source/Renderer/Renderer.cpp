...
Renderer::Renderer()
{
    ...
    // Load Shaders
    vertex_shader_.LoadFromHlsl(gfx::device.Get(), "assets/shaders/vs_textured_cube.hlsl");
    pixel_shader_.LoadFromHlsl(gfx::device.Get(), "assets/shaders/ps_textured_cube.hlsl");
